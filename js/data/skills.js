// skills.js — 全技データ。SKILL_MAPでIDをキーに引ける。
export const SKILLS = [
  // ── 火属性 ──
  ...
  { id:'grass_strike_2', name:'ソーンレイン',       description:'無数の棘が降り波す。',         chargeTime:17, damage:1100, type:'damage', effect:'poison',effectDuration:4, range:240 },
  { id:'grass_strike_3', name:'グランドリーパー',   description:'大地が裂け根が絡め取る。',   chargeTime:22, damage:1900, type:'damage', effect:'poison',effectDuration:6, range:270 },
  ...
  { id:'light_wall_3',   name:'ホーリーバスティオン',description:'聖域を守る光の要塞。',     chargeTime:26, damage:700,  type:'buff',   effect:'defend',effectDuration:8, range:130 },
  // ── 闇属性 ──
  ...
  { id:'dark_strike_2',  name:'ナイトメアファング',  description:'悪夢の牙が魚を噛む。',         chargeTime:17, damage:1300, type:'damage', effect:'curse', effectDuration:4, range:220 },
  ...
  // ── 竜 ──
  { id:'dragon_breath',  name:'ドラゴンブレス',     description:'全属性の息吹き。',               chargeTime:25, damage:2500, type:'damage', effect:'burn',  effectDuration:4, range:300 },
];
